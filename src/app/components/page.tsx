    ...
    <Container maxWidth="lg" sx={{ py: 6 }}>
      ...
      <Section title="AppAlert">
        <Stack gap={1.5}>
          ...
          <AppAlert severity="warning">Warning — please review before proceeding.</AppAlert>
      ...
      <Section title="StatCard">
        <Grid container spacing={3}>
          {[
            { label: 'Total Users', value: '3,842', description: '+12% from last month' },
            { label: 'Active Sessions', value: '128', description: 'Live right now' },
            ...
            <Grid item xs={12} sm={6} md={3} key={label}>
              <StatCard label={label} value={value} description={description} loading={l} />
            </Grid>
          ))}
        </Grid>
      </Section>
      ...
      <Section title="EmptyState">
        <EmptyState
          ...
          sx={{ border: '1px dashed', borderColor: 'divider', borderRadius: 2, py: 6 }}
        />
      </Section>
